        ...
        <>
            <group position={[0,2,-8]}>
                ...
                <mesh>
                    ...
                    <meshBasicMaterial color={new Color(0x777FF)} transparent opacity={0.5}/>
                </mesh>
            </group>
            ...
            <group position={[0,2,8]}>
                ...
                <mesh>
                    ...
                    <meshBasicMaterial color={new Color(0)} wireframe opacity={0.2} transparent/>
                </mesh>
            </group>
        ...
        <>
            <group position={[16,8,0]}>
                <Html position={[-1,0,0]}>
                    ...
                    <Typography>flat shading</Typography> <Switch
                        checked={flat}
